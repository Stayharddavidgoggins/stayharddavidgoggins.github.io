  ...
  return (
    <section id="about" className="about-section">
      <img
        ...
        alt=""
        aria-hidden="true"
        className="about-corner about-corner-top-right"
      />
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="about-corner about-corner-top-left"
      />
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="about-corner about-corner-bottom-right"
      />
      ...
      <img
        ...
        alt=""
        aria-hidden="true"
        className="about-corner about-corner-bottom-left"
      />
      ...
      <div className="about-grid">
        <article className="about-card about-card-intro">
          ...
          <p>
            I am Leevi “Rushn” Kotkavalkama, a 17-year-old player working toward
        ...
        <article className="about-card about-card-esports">
          ...
          <p>
            I have over four years of experience in competitive gaming and have
            competed in multiple tournaments, including the 2025 ELC and Fire
            Challenger series.
          </p>
        </article>
        ...
        <article className="about-card about-card-community">
          ...
          <p>
            ...
            where I play with viewers daily. Join in through Discord or email me
